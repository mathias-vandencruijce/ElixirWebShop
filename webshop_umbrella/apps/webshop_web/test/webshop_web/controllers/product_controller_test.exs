defmodule WebshopWeb.ProductControllerTest do
  use WebshopWeb.ConnCase

  alias Webshop.ProductContext

  @create_attrs %{color: "some color", description: "some description", price: 120.5, size: 120.5, stock: 42, title: "some title"}
